...
import 'package:appshopthoitran/Controller/chats_controller.dart';
import 'package:appshopthoitran/Views/chat_screen/components/sender_bubble.dart';
                  ...
                  : Expanded(
                      ...
                      builder: (BuildContext context,
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return Center(
                            child:
                                "Chưa có tin nhắn nào ! Hãy bắt đầu 1 tin nhắn chào"
                                    .text
                                    .color(darkFontGrey)
                                    .make(),
                          );
